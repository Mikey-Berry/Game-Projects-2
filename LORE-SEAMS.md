...
5. **The largest unbuilt pieces:** the Last Scholar, the kingdom's crater, and the tablets of
   ...
   complete. **The crater is being built** (§4, phases 1 and 2 of 3 in).
...
| **The kingdom's crater** (§16): "should be the largest landmark in the world", and the natural site of the Door | **Building, 2026-09-25.** Phase 1 (the place) is in: it is at the dead centre of every world and the world is placed around it. Four rings, from the outside: the approach (ash, dead trees leaning away from the middle, the Order's posts, bones), the glass (fused ground, standing slabs with shadows burned onto them), the rim (a wall with four breaches) and the bowl, with a veil of light over it. Phase 2 (the danger) is in: the glass and the bowl are held day and night by Watchers the dawn does not take, the Messengers stand in the bowl at peace with them, what is killed grows back out of sight, and at night telegraphed strikes of light come down on whoever of yours is in the glass. `tools/crater.js` checks both. Still to come: the ruins, caches, a Messenger boss, and the Door opening there. |
